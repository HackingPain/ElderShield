...
async function syncEmergencyData() {
  try {
    ...
    console.log('SeniorCare Hub SW: Emergency data synced');
  } catch (error) {
...
async function syncCheckInData() {
  try {
    ...
    console.log('SeniorCare Hub SW: Check-in data synced');
  } catch (error) {
...
async function syncMedicationData() {
  try {
    ...
    console.log('SeniorCare Hub SW: Medication data synced');
  } catch (error) {
